...
export const createMockTheme = () => ({
  ...
  colors: {
    ...
    // Ordered risk scale, low to extreme.
    riskLow: '#0F7A57',
    riskLowSurface: 'rgba(15, 122, 87, 0.12)',
    riskModerate: '#B7791F',
    riskModerateSurface: 'rgba(183, 121, 31, 0.12)',
    riskHigh: '#D35400',
    riskHighSurface: 'rgba(211, 84, 0, 0.12)',
    riskExtreme: '#A61B1B',
    riskExtremeSurface: 'rgba(166, 27, 27, 0.12)',
