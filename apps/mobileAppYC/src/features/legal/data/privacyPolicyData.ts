...
export const PRIVACY_POLICY_SECTIONS: LegalSection[] = [
...

  {
    ...
    blocks: [
      p(
        b('Purpose: '),
        seg(
          'To enable Pet owner/Companion Owner to book appointments with veterinarians through the Yosemite Crew mobile application.',
        ),
      ),
      p(
        b('Categories of data: '),
...

  {
    ...
    blocks: [
      ...
      p(
        b('Categories of data: '),
        seg('Rating (in the form of stars), review text, name, timestamp.'),
      ),
      p(b('Recipients:')),
      createReviewRecipientsList(),
      createConsentBasis(),
