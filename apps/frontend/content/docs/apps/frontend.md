...
This project uses [`next/font`](https://nextjs.org/docs/app/building-your-application/optimizing/fonts) to self-host [Newsreader](https://fonts.google.com/specimen/Newsreader), the display serif used for page titles and greeting moments. It is imported in `src/app/layout.tsx`.
