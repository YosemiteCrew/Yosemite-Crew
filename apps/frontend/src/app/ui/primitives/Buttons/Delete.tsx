...
const baseClasses =
  'px-5 gap-2 flex items-center justify-center rounded-full! transition-[background-color,opacity] duration-200 ease-out text-[14px] font-semibold text-white bg-[var(--danger)] hover:opacity-90 active:opacity-100';
