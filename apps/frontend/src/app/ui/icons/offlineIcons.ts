...
// and add one line below. offlineIcons.test.ts asserts this map covers every
// name the app renders, so a missing one fails CI rather than silently not
// drawing (the CSP no longer permits the remote lookup).

/** Square icon: the sets used here all publish on a square viewBox. */
const square = (size: number, body: string): IconifyIcon => ({ body, width: size, height: size });
...
export const OFFLINE_ICONS: Readonly<Record<string, IconifyIcon>> = {
  ...
  'ion:cloud-upload-outline': square(
    512,
  ...
  'ion:color-palette-outline': square(
    512,
  ...
  'ion:extension-puzzle-outline': square(
    512,
  ...
  'ion:flask-outline': square(
    512,
    '<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="10" stroke-width="32" d="M176 48h160M118 304h276M208 48v93.48a64.1 64.1 0 0 1-9.88 34.18L73.21 373.49C48.4 412.78 76.63 464 123.08 464h265.84c46.45 0 74.68-51.22 49.87-90.51L313.87 175.66a64.1 64.1 0 0 1-9.87-34.18V48"/>'
  ),
  'ion:home-outline': square(
    512,
    '<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="32" d="M80 212v236a16 16 0 0 0 16 16h96V328a24 24 0 0 1 24-24h80a24 24 0 0 1 24 24v136h96a16 16 0 0 0 16-16V212"/><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="32" d="M480 256L266.89 52c-5-5.28-16.69-5.34-21.78 0L32 256m368-77V64h-48v69"/>'
  ),
  'ion:information-circle-outline': square(
    512,
  ...
  'ion:pulse-outline': square(
    512,
    '<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="32" d="M48 320h64l64-256l64 384l64-224l32 96h64"/><circle cx="432" cy="320" r="32" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="32"/>'
  ),
  'ion:rocket-outline': square(
    512,
  ...
  'ion:shield-checkmark-outline': square(
    512,
  ...
  'solar:check-circle-bold': square(
    24,
    '<path fill="currentColor" fill-rule="evenodd" d="M22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12ZM16.0303 8.96967C16.3232 9.26256 16.3232 9.73744 16.0303 10.0303L11.0303 15.0303C10.7374 15.3232 10.2626 15.3232 9.96967 15.0303L7.96967 13.0303C7.67678 12.7374 7.67678 12.2626 7.96967 11.9697C8.26256 11.6768 8.73744 11.6768 9.03033 11.9697L10.5 13.4393L12.7348 11.2045L14.9697 8.96967C15.2626 8.67678 15.7374 8.67678 16.0303 8.96967Z" clip-rule="evenodd"/>'
  ),
  'solar:close-circle-bold': square(
    24,
