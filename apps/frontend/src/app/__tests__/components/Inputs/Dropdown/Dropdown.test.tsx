...
describe('Dropdown Component', () => {
  ...
  it('renders disabled state correctly', () => {
    render(<Dropdown placeholder="Select Item" value="" onChange={mockOnChange} disabled />);
  ...
  it('opens dropdown on click and closes on second click', () => {
    render(<Dropdown placeholder="Select" value="" onChange={mockOnChange} options={['A', 'B']} />);
  ...
  it('closes dropdown when clicking outside', () => {
    render(
      <div>
        ...
        <Dropdown placeholder="Select" value="" onChange={mockOnChange} options={['A']} />
      </div>
    );
  ...
  it('handles object options ({ label, value }) selection', () => {
    ...
    render(<Dropdown placeholder="Select" value="" onChange={mockOnChange} options={options} />);
  ...
  it("handles type='country' correctly", () => {
    render(
      <Dropdown placeholder="Select Country" value="" onChange={mockOnChange} type="country" />
    );
  ...
  it('handles mixed/fallback option types', () => {
    ...
    render(<Dropdown placeholder="Mix" value="" onChange={mockOnChange} options={options} />);
