...
describe('ServiceCard Component', () => {
  ...
  it('renders static text instead of input in View mode (edit=false)', () => {
    render(<ServiceCard service={mockService} setFormData={mockSetFormData} edit={false} />);
  ...
  it('handles missing discount value in View mode (fallback to 0)', () => {
    ...
    render(<ServiceCard service={noDiscountService} setFormData={mockSetFormData} edit={false} />);
  ...
  it('applies border class correctly in View mode', () => {
    ...
    expect(container).toHaveClass('border-b border-card-border');
  });
