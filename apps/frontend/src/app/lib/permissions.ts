export const PERMISSIONS = {
  ...
  LABS_VIEW_ANY: 'labs:view:any',
  LABS_EDIT_ANY: 'labs:edit:any',

  INTEGRATIONS_VIEW_ANY: 'integrations:view:any',
  INTEGRATIONS_EDIT_ANY: 'integrations:edit:any',
} as const;

export type Permission = (typeof PERMISSIONS)[keyof typeof PERMISSIONS];

export const ALL_PERMISSIONS = new Set<Permission>(Object.values(PERMISSIONS) as Permission[]);
