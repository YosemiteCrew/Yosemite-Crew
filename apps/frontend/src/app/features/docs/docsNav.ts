 ...
 *
 * The Backend API section is deliberately not listed page by page. It is
 * every router reference page (one per `*.router.ts` under `apps/backend/src/routers`,
 * generated by `scripts/generate-router-docs.mjs`), and enumerating them here would
 * mean editing this file every time a router is added.
 */
