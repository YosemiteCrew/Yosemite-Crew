...
export const TERMS_EXHIBIT_A_SECTIONS: LegalSection[] = [
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        content: [
          {
            text: '1.5. Monthly Availability Percentage',
            bold: true,
            k: 'r0',
          },
      ...
      },
      {
        ...
        content: [
          ...
          {
            text: '“Technical Support Contacts”',
            bold: true,
            k: 'r3',
          },
      ...
      {
        type: 'h3',
        content: ['3. Support Services subscriptions'],
        k: 'b10',
      },
      {
        type: 'p',
      ...
      {
        type: 'h3',
        content: ['4. SaaS Service availability'],
        k: 'b12',
      },
      {
        type: 'p',
      ...
      {
        type: 'h3',
        content: ['5. Service Level Credits'],
        k: 'b14',
      },
      {
        type: 'p',
      ...
      {
        type: 'h3',
        content: ['6. Customer Support Center contact'],
        k: 'b18',
      },
      {
        type: 'table',
      ...
      {
        type: 'h3',
        content: ['7. Error response service levels'],
        k: 'b20',
      },
      {
        type: 'p',
