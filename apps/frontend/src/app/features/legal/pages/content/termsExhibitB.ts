...
export const TERMS_EXHIBIT_B_SECTIONS: LegalSection[] = [
  {
    id: 'exhibit-b',
    title: 'Exhibit B: Data Processing Agreement',
    blocks: [
      {
        type: 'p',
        content:
      ...
      { type: 'h3', content: '1. Application of the Standard Contractual Clauses', k: 'b4' },
      {
        type: 'ol',
        items: [
          {
            ...
            blocks: [
              {
                type: 'text',
                content:
                  'The Parties conclude the Standard Contractual Clauses between controllers and processors as agreed upon by the European Commission in its Commission Implementing Decision (EU) 2021/915 of June 4 2021 and attached to this DPA as APPENDIX 1 (the “EU-Standard Contractual Clauses”). For clarity, Processor’s obligations and Controller’s rights concerning Personal Data apply even if the Personal Data relates to a data subject outside the European Union.',
                k: 'b0',
              },
            ],
          },
            ...
            blocks: [
              {
                type: 'text',
                content:
                  'The EU-Standard Contractual Clauses and International Standard Contractual Clauses will be supplemented by the provisions of this DPA.',
                k: 'b0',
              },
            ],
          },
      ...
      { type: 'h3', content: '2. Instructions of the Controller', k: 'b6' },
      {
        type: 'ol',
        items: [
          {
            ...
            blocks: [
              {
                type: 'text',
                content:
                  'The Controller’s initial instructions shall be set out by the provisions of the Yosemite Crew License and Subscription Terms (SaaS), its Annexes and Appendices and any related agreement.',
                k: 'b0',
              },
            ],
          },
            ...
            blocks: [
              {
                type: 'text',
                content:
                  'The Controller shall be entitled to modify, amend or replace such individual instructions by issuing new instructions to the point of contact designated by the Processor. The instruction shall be given either in written form (email to suffice). In case of an oral instruction, the Controller shall immediately confirm this instruction in written form (email to suffice).',
                k: 'b0',
              },
            ],
          },
            ...
            blocks: [
              {
                type: 'text',
                content:
                  'Instructions not foreseen in or covered by the Yosemite Crew License and Subscription Terms (SaaS) shall be treated as requests for change in performance. The Controller shall immediately confirm in writing or in text form any instruction issued orally.',
                k: 'b0',
              },
            ],
          },
      ...
      { type: 'h3', content: '3. Technical and Organisational Measures', k: 'b8' },
      {
        type: 'p',
        content:
      ...
      { type: 'h3', content: '4. Obligations of the Controller', k: 'b10' },
      {
        type: 'ol',
        items: [
          {
            ...
            blocks: [
              {
                type: 'text',
                content:
                  'The Controller shall notify the Processor without undue delay of any defect or irregularity of the services with regard to the processing of personal data detected by the Controller.',
                k: 'b0',
              },
            ],
          },
            ...
            blocks: [
              {
                type: 'text',
                content:
                  'The Controller shall notify the Processor’s point of contract for any issue related to data protection arising out of or in connection with the Yosemite Crew License and Subscription Terms (SaaS).',
                k: 'b0',
              },
            ],
          },
      ...
      { type: 'h3', content: '5. Inspections', k: 'b12' },
      {
        type: 'ol',
        items: [
          {
            ...
            blocks: [
              {
                type: 'text',
                content:
                  'In cases where the EU-Standard Contractual Clauses apply, the Controller shall give the Processor reasonable notice before conducting an audit according to Clause 7.6 of the EU-Standard Contractual Clauses unless such notice is impossible to provide or would defeat the purpose of the audit.',
                k: 'b0',
              },
            ],
          },
            ...
            blocks: [
              {
                type: 'text',
                content:
                  'In cases where the EU-Standard Contractual Clauses apply, Processor shall be entitled to request a remuneration for Processor’s support in conducting audits in accordance with the then current price list of Processor.',
                k: 'b0',
              },
            ],
          },
      ...
      { type: 'h3', content: '6. Remuneration for Supporting Obligations', k: 'b14' },
      {
        type: 'p',
        content:
