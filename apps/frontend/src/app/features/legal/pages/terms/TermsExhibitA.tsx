...
export const TermsExhibitA = () => (
  <>
    <DocSection id="exhibit-a" title="Exhibit A: Support Services and Service Level Policy">
      <h3>1. Definitions</h3>
      <p>
        <strong>1.1. Emergency Downtime</strong> means such time as the SaaS Service is offline due
        to a short-term emergency condition, provided that: (a) the incident lasts less than three
        (3) hours; and (b) there have been no prior Emergency Downtime incidents within 90 days
        before the incident.
      </p>
      <p>
        ...
        nature, war, riot, civil action, terrorism, labor dispute, malicious acts or denial of
        service by a third party, or failure of telecommunication systems or utilities (“Force
        Majeure Event”).
      </p>
      <p>
        <strong>1.3. Error</strong> means a failure of the SaaS Service to conform to the
        specifications set forth in the Documentation, resulting in the inability to use, or
        material restriction in the use of the SaaS Service.
      </p>
      <p>
        <strong>1.4. Maintenance Downtime</strong> means such time as the SaaS Service is offline
        for maintenance or backup purposes, provided that the incident is scheduled with Customer at
      ...
      <p>
        <strong>1.6. Start Time</strong> means the time at which DuneXploration first becomes aware
        of an Error.
      </p>
      <p>
        ...
        Documentation. An Update may be an error correction or bug fix; or it may be enhancement,
      ...
      <p>
        ...
        <a href="mailto:support@yosemitecrew.com"> support@yosemitecrew.com </a> ) and a discord
        chat ({' '}
      ...
      <p>
        ...
        p.m. (DuneXploration’s local time). Submitted Errors will be classNameified by severity as
        set forth in the table below. Customer may assign two (2) Technical Support Contacts, which
        may contact the Customer Support Center through any of the Customer Support Center Contacts,
        as set forth below.
      </p>
      ...
      <ul>
        ...
        <li>
          ...
          be eligible for a credit of 5% of a monthly average fee derived from one-twelfth (1/12th)
        ...
        <li>
          ...
          be eligible for a credit of 7.5% of a monthly average fee derived from one-twelfth
          (1/12th) of the then-current annual fee paid to DuneXploration; or
        </li>
        <li>
      ...
      <p>
        ...
        notifies DuneXploration in writing within thirty (30) days from the end of the month for
        which Service Level Credits are due. All claims will be verified against DuneXploration’s
        system records. In the event after such notification DuneXploration determines that Service
        Level Credits are not due, or that different Service Level Credits are due, DuneXploration
        shall notify Customer in writing on that finding. Service Level Credits will be applied to
        the next invoice following Customer’s request and DuneXploration’s confirmation of available
        credits. Service Level Credits shall be Customer’s sole and exclusive remedy in the event of
        any failure to meet the Service Levels. DuneXploration will only provide records of system
      ...
      <p>
        ...
        accordance with the severity designation and validate Customer’s severity level designation
        or notify Customer of a proposed change in the severity level designation with justification
        for the change. DuneXploration will provide continuous efforts to resolve Severity 1 issues
        until a workaround or resolution can be provided or until the incident can be downgraded to
        a lower severity. DuneXploration will use reasonable efforts to meet the target response
        times for the Errors stated in the table below.
      </p>
      <table>
        <caption className="sr-only">
        ...
        <tbody>
          <tr>
            ...
            <td>
              ...
              DuneXploration will promptly: (i) assign a specialist to correct the Error; (ii)
              provide ongoing communication on the status of an Update; and (iii) begin to provide a
          ...
          <tr>
            ...
            <td>
              ...
              functions are limited. DuneXploration will promptly: (i) assign a specialist to
              correct the Error; and (ii) provide additional escalated Support Services as
          ...
          <tr>
            ...
            <td>
              ...
              DuneXploration will triage the request and may include a resolution in the next
              Update.
            </td>
