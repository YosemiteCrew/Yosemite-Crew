  ...
  <>
    <div className="privacyHead">
      ...
      <p>
        ...
        practice management software (hereinafter referred to as “PMS” or “the Software”). Our
        Software is available as a web application and as a mobile application. Unless stated
        otherwise, the information provided applies equally to both versions. This policy helps you
        to understand what information we collect, why we collect it, how we use it, and how long we
        store it.
      </p>
    </div>
    ...
    <div className="PolicyItems">
      ...
      <p>
        ...
        <span className="warningtext">(haftungsbeschränkt)</span> <br /> Am Finther Weg 7 <br />{' '}
        55127 Mainz <br /> <span className="spanlink">security@yosemitecrew.com</span>
      </p>
      <p>
    ...
    <div className="PolicyItems">
      ...
      <div className="policyul">
        <p>
          Depending on the processing activity, <span className="warningtext">DuneXploration</span>{' '}
          may act as a controller or processor:
        </p>
        <ul>
          <li>
            <span className="warningtext">DuneXploration</span> is the controller when it determines
            how and why your data is processed, for example when you create a user account
          </li>
          <li>
      ...
      <p>
        Regardless of whether <span className="warningtext">DuneXploration</span> is the controller
        or processor, <span className="warningtext">DuneXploration</span> takes appropriate measures
        to ensure the protection and confidentiality of the personal data that{' '}
        <span className="warningtext">DuneXploration</span> processes in accordance with the
        provisions of the GDPR and the legislation in Germany.
      </p>
    </div>
  </>
);

const PrivacyPart2Sub1 = () => (
  <>
    <div className="PolicyItems">
...
const PrivacyPart2Sub2 = () => (
  <>
    ...
    <div className="PolicyItems">
      ...
      <p>
        <strong>Categories of data: </strong> Rating (in the form of starts), review text, name,
        timestamp.
      </p>
      ...
      <div className="policyul">
        ...
        <ul>
          <li>
            Any user of the PMS - including the pet service provider selected by the user - can view
            the review.
          </li>
          <li>Amazon Web Services EMEA SARL, 38 Avenue John F. Kennedy, L-1855, Luxemburg.</li>
          <li>
  ...
  <>
    <div className="PolicyItems">
      ...
      <div className="policyul">
        <p>
          <strong>
            In addition to these specific recipients, data may also be transferred to other
            categories of recipients. These may be internal recipients, i.e., persons within our
            company, but also external recipients. Possible recipients may include, in particular:
          </strong>
        </p>
        <ul>
          <li>
            Our employees who are responsible for processing and storing the data and whose
            employment relationship with us is governed by a confidentiality agreement.
          </li>
          <li>
          ...
          <li>
            ...
            terms and conditions. For example: payment service providers, marketing service
          ...
          <li>
            ...
            include reporting suspected fraud or criminal activity and cases of responsible gaming
            to the relevant authorities or authorized third parties.
          </li>
        </ul>
      </div>
    </div>
    ...
    <div className="PolicyNumbdetail">
      <div className="PolicyItems">
        <h3>8. What rights do you have with regard to the personal data you provide to us?</h3>
        <p>
          ...
          <Link href="security@yosemitecrew.com"> security@yosemitecrew.com</Link> .
        </p>
      </div>
      <div className="PolicyItems">
        <h3>Art. 15 GDPR – Right of access by the data subject:</h3>
        <p>
          You have the right to obtain confirmation from us as to whether personal data concerning
          you are being processed and, if so, which data are being processed and the circumstances
      ...
      <div className="PolicyItems">
        ...
        <p>
          ...
          concerning you. Taking into account the purposes of the processing, you also have the
