...
const PhoneWorkspaceShell = ({
  ...
  return (
    // #main-content already insets the fixed 54px header and 72px tab bar (top/
    // bottom padding, no horizontal padding - see PhoneShell.css), so the shell
    // runs edge-to-edge without any bleed and its body scrolls internally.
