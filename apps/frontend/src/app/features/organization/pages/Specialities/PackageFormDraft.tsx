      ...
      <SectionContainer title="Breakdown" nested titleColor="var(--color-neutral-900)">
        <div className="flex flex-col gap-4">
          <div className="relative">
            <div className="flex items-center gap-2 w-full border border-input-border-default rounded-2xl px-3.5 h-10.5 focus-within:border-input-border-active transition-colors bg-neutral-0">
              <input
                type="text"
            ...
            {filteredSearch.length > 0 && (
              <div className="absolute top-full left-0 right-0 z-50 mt-1 bg-neutral-0 border border-card-border rounded-2xl shadow-lg overflow-hidden">
            ...
            {searchQuery.trim() && filteredSearch.length === 0 && !searchLoading && (
              <div className="absolute top-full left-0 right-0 z-50 mt-1 bg-neutral-0 border border-card-border rounded-2xl shadow-lg px-4 py-3 text-body-4 text-text-secondary">
                No items found.
              </div>
            )}
          </div>
