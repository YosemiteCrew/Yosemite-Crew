...
export type AuditEventType =
  ...
  | "PRESCRIPTION_SIGNED"
  | "PRESCRIPTION_VOIDED"
  | "PRESCRIPTION_DISPENSE_REQUESTED"
  | "PRESCRIPTION_DISPENSED"
  | "PRESCRIPTION_DISPENSE_REJECTED"
  | "DISCHARGE_SUMMARY_CREATED"
  | "DISCHARGE_SUMMARY_UPDATED"
  | "PATIENT_CHECKED_IN"
  | "PATIENT_SEEN"
  | "ANAESTHESIA_STARTED"
  | "ANAESTHESIA_COMPLETED"
  | "ANAESTHESIA_ABORTED"
  | "STAFF_SHIFT_SCHEDULED"
  | "STAFF_SHIFT_UPDATED"
  | "STAFF_SHIFT_CANCELLED"
  | "TREATMENT_OUTCOME_RECORDED"
  | "MEDICAL_CERTIFICATE_ISSUED"
  | "MEDICAL_CERTIFICATE_REVOKED"
  | "PATIENT_FLAG_CREATED"
  | "PATIENT_FLAG_RESOLVED"
  | "INVENTORY_COUNT_RECORDED"
  | "INVENTORY_DISCREPANCY_RECONCILED"
  | "CLINIC_NOTE_CREATED"
  | "CLINIC_NOTE_PINNED";
