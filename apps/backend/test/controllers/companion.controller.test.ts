...
describe("CompanionController", () => {
  ...
  describe("createCompanionMobile", () => {
    ...
    it("should handle generic errors", async () => {
      req.body = validFHIR;
      (CompanionService.create as jest.Mock).mockRejectedValue(
  ...
  describe("createCompanionPMS", () => {
    ...
    it("should handle custom and generic errors", async () => {
      ...
      (CompanionService.create as jest.Mock).mockRejectedValue(
        new CompanionServiceError("Custom", 409),
      );
      await CompanionController.createCompanionPMS(req, res);
  ...
  describe("getCompanionById", () => {
    ...
    it("should handle errors", async () => {
      req.params.id = "c1";
      (CompanionService.getById as jest.Mock).mockRejectedValue(
        new CompanionServiceError("C", 403),
      );
      await CompanionController.getCompanionById(req, res);
  ...
  describe("updateCompanion", () => {
    ...
    it("should return 200 on success", async () => {
      req.params.id = "c1";
      req.body = validFHIR;
      (CompanionService.update as jest.Mock).mockResolvedValue({
        response: "updated",
      });
      await CompanionController.updateCompanion(req, res);
      expect(res.status).toHaveBeenCalledWith(200);
    ...
    it("should handle errors", async () => {
      req.params.id = "c1";
      req.body = validFHIR;
      (CompanionService.update as jest.Mock).mockRejectedValue(
        new Error("Test error"),
      );
      await CompanionController.updateCompanion(req, res);
      expect(res.status).toHaveBeenCalledWith(500);
  ...
  describe("deleteCompanion", () => {
    ...
    it("should return 204 on success", async () => {
      ...
      expect(CompanionService.delete).toHaveBeenCalledWith("c1", {
        authUserId: "auth_user_123",
      });
    });
    ...
    it("should handle custom and generic errors", async () => {
      req.params.id = "c1";
      (CompanionService.delete as jest.Mock).mockRejectedValue(
        new CompanionServiceError("err", 404),
      );
      await CompanionController.deleteCompanion(req, res);
      expect(res.status).toHaveBeenCalledWith(404);
  ...
  describe("searchCompanionByName", () => {
    ...
    it("should return 200 and search results", async () => {
      req.query.name = "Fido";
      (CompanionService.getByName as jest.Mock).mockResolvedValue({
        responses: ["res1"],
      });
      await CompanionController.searchCompanionByName(req, res);
      expect(res.status).toHaveBeenCalledWith(200);
    ...
    it("should handle errors", async () => {
      req.query.name = "Fido";
      (CompanionService.getByName as jest.Mock).mockRejectedValue(
        new CompanionServiceError("err", 403),
      );
      await CompanionController.searchCompanionByName(req, res);
      expect(res.status).toHaveBeenCalledWith(403);
  ...
  describe("getCompanionsByParentId", () => {
    ...
    it("should return 200 and search results", async () => {
      ...
      (CompanionService.listByParent as jest.Mock).mockResolvedValue({
        responses: ["comp1"],
      });
      await CompanionController.getCompanionsByParentId(req, res);
      expect(res.status).toHaveBeenCalledWith(200);
    ...
    it("should handle custom and generic errors", async () => {
      req.params.parentId = "p1";
      (CompanionService.listByParent as jest.Mock).mockRejectedValue(
        new CompanionServiceError("err", 404),
      );
      await CompanionController.getCompanionsByParentId(req, res);
      expect(res.status).toHaveBeenCalledWith(404);
