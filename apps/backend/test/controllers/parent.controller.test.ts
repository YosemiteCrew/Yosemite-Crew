  ...
  describe("Mobile Controllers", () => {
    describe("createParentMobile", () => {
      ...
      it("should return 201 on success", async () => {
        req.body = validFHIR;
        (ParentService.create as jest.Mock).mockResolvedValue({
          response: "created",
        });
        await ParentController.createParentMobile(req, res);
      ...
      it("should handle generic errors", async () => {
        req.body = validFHIR;
        (ParentService.create as jest.Mock).mockRejectedValue(
    ...
    describe("getParentMobile", () => {
      ...
      it("should return 200 on success", async () => {
        req.params.id = "p1";
        (ParentService.get as jest.Mock).mockResolvedValue({
          response: "data",
        });
        await ParentController.getParentMobile(req, res);
      ...
      it("should handle custom and generic errors", async () => {
        req.params.id = "p1";
        (ParentService.get as jest.Mock).mockRejectedValue(
          new ParentServiceError("Custom", 403),
        );
        await ParentController.getParentMobile(req, res);
    ...
    describe("updateParentMobile", () => {
      ...
      it("should handle errors", async () => {
        req.params.id = "p1";
        req.body = validFHIR;
        (ParentService.update as jest.Mock).mockRejectedValue(
          new Error("Test error"),
        );
        await ParentController.updateParentMobile(req, res);
        expect(res.status).toHaveBeenCalledWith(500);
    ...
    describe("deleteParentMobile", () => {
      ...
      it("should handle errors", async () => {
        req.params.id = "p1";
        (ParentService.delete as jest.Mock).mockRejectedValue(
          new Error("Test error"),
        );
        await ParentController.deleteParentMobile(req, res);
        expect(res.status).toHaveBeenCalledWith(500);
