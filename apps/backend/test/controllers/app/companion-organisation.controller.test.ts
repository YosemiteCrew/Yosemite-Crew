...
const { CompanionOrganisationServiceError } = jest.requireActual(
  "../../../src/services/companion-organisation.service",
) as unknown as any;
...
describe("CompanionOrganisationController", () => {
  ...
  describe("linkByParent", () => {
    ...
    it("should success (201)", async () => {
      ...
      mockedCompanionService.linkByParent.mockResolvedValue({
        id: "link1",
      } as any);
  ...
  describe("approvePendingLink", () => {
    it("should 401 if no auth", async () => {
      await CompanionOrganisationController.approvePendingLink(
        req as Request,
        res as Response,
      );
      expect(statusMock).toHaveBeenCalledWith(401);
  ...
  describe("denyPendingLink", () => {
    it("should 401 if no auth", async () => {
      await CompanionOrganisationController.denyPendingLink(
        req as Request,
        res as Response,
      );
      expect(statusMock).toHaveBeenCalledWith(401);
  ...
  describe("sendInvite", () => {
    ...
    it("should success (201) with email", async () => {
      ...
      expect(mockedCompanionService.sendInvite).toHaveBeenCalledWith(
  ...
  describe("revokeLink", () => {
    it("should 401 when no authenticated parent", async () => {
      req.params = { linkId: "l1" };
      await CompanionOrganisationController.revokeLink(
        req as Request,
        res as Response,
      );
      expect(statusMock).toHaveBeenCalledWith(401);
      expect(mockedCompanionService.revokeLink).not.toHaveBeenCalled();
    });

    it("should 401 when authenticated user is not a parent", async () => {
      (req as any).userId = "u1";
      mockedParentService.findByLinkedUserId.mockResolvedValue(null);
      req.params = { linkId: "l1" };
      await CompanionOrganisationController.revokeLink(
    ...
    it("should success (200), scoped to the authenticated parent", async () => {
      (req as any).userId = "u1";
      mockedParentService.findByLinkedUserId.mockResolvedValue({
        _id: validObjectId,
      } as any);
      ...
      expect(mockedCompanionService.revokeLink).toHaveBeenCalledWith(
        "l1",
        validObjectId,
      );
      expect(statusMock).toHaveBeenCalledWith(200);
  ...
  describe("getLinksForOrganisation", () => {
    it("should success", async () => {
      ...
      mockedCompanionService.getLinksForOrganisation.mockResolvedValue(
        [] as any,
      );
      await CompanionOrganisationController.getLinksForOrganisation(
        req as Request,
        res as Response,
      );
      expect(statusMock).toHaveBeenCalledWith(200);
  ...
  describe("getLinksForCompanionByOrganisationType", () => {
    it("should 401 when no authenticated parent", async () => {
      ...
      expect(statusMock).toHaveBeenCalledWith(401);
      expect(
        mockedCompanionService.getLinksForCompanionByOrganisationTye,
      ).not.toHaveBeenCalled();
    });
    ...
    it("should success, scoped to the authenticated parent", async () => {
      (req as any).userId = "u1";
      mockedParentService.findByLinkedUserId.mockResolvedValue({
        _id: validObjectId,
      } as any);
