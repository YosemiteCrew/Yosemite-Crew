...
describe("getCellRisk", () => {
  ...
  it("rejects a fallback older than one week", async () => {
    ...
    await expect(getCellRisk(BRISBANE.lat, BRISBANE.lon, "AU")).rejects.toThrow(
      "provider down",
    );
  });
...
describe("upsertSubscription", () => {
  ...
  it("locks a parent's count-and-create transaction", async () => {
