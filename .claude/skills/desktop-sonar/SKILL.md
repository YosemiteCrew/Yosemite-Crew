...
> Surface note: this is the Claude Code copy. Mandatory checks live in `apps/desktop/AGENTS.md`;
> the skill index is in the repo root `CLAUDE.md`. The Codex copy is `.agents/skills/desktop-sonar/`.
